...
void ShowMenu() {
	...
	cout << "Add New Student   4\n";
	cout << "Add New Teacher   5\n";
}
...
void AddNewStudent(Student**& students) {
	...
	Student** newstudents = new Student * [academy->overall_student_count + 1]{};

	for (size_t i = 0; i < academy->overall_student_count; i++)
	{
		newstudents[i] = students[i];
	}
	newstudents[academy->overall_student_count] = student;

	students = newstudents;
	newstudents = nullptr;
	academy->overall_student_count++;
}


void AddNewTeacher(Teacher**& teachers) {


	auto teacher = getNewTeacher();
	Teacher** newteachers = new Teacher * [academy->teacher_count + 1]{};

	for (size_t i = 0; i < academy->teacher_count; i++)
	{
		newteachers[i] = teachers[i];
	}
	newteachers[academy->teacher_count] = teacher;
